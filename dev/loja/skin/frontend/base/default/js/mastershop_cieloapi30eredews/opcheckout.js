	...
	Review.prototype.nextStep = Review.prototype.nextStep.wrap(
		function (pFuncaoOriginal, pTransporte)
		{
			if (pTransporte)
			{
				...
				{
					//Limpar campos
					$$('input[id^=mastershopcieloapi30eredews_cc_]', 'select[id^=mastershopcieloapi30eredews_cc_]').each(
						function (elemento)
						{
					...
					mastershop_cieloapi30eredews_atualizarBandeirasImagens();
					mastershop_cieloapi30eredews_inicializarCampos();
