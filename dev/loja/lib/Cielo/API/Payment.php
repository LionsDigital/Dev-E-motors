...
class Cielo_API_Payment implements \JsonSerializable
{
    ...
    public function populate(\stdClass $data)
    {
        ...
        {
            $this->recurrentPayment = new Cielo_API_RecurrentPayment(false);
            $this->recurrentPayment->populate($data->RecurrentPayment);
        }
        
        if (isset($data->CreditCard))
        {
            $this->creditCard = new Cielo_API_CreditCard();
    ...
    {
        $recurrentPayment = new Cielo_API_RecurrentPayment($authorizeNow);
    ...
    public function setCreditCard(Cielo_API_CreditCard $creditCard)
    {
