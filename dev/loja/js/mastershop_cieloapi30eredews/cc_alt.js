...
mastershop_cieloapi30eredews_desselecionarBandeira = function (pNumCartao)
{
...
mastershop_cieloapi30eredews_selecionarBandeira = function (pCampo, pNumCartao)
{
	...
	if (typeof(mastershop_cieloapi30eredews_selecaoCc) != 'object')
	{
		return false;
	}
	...
	for (var codigoCartao in mastershop_cieloapi30eredews_selecaoCc)
	{
		var re = new RegExp(mastershop_cieloapi30eredews_selecaoCc[codigoCartao], 'g');
	...
	if (selecionarCartao == '')
	{
		mastershop_cieloapi30eredews_desselecionarBandeira(pNumCartao);
		mastershop_cieloapi30eredews_atualizarBandeirasImagens(pNumCartao);
		return;
	}
...
mastershop_cieloapi30eredews_verificarCartaoCompleto = function (pCampo, pNumCartao)
{
