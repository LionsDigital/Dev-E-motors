...
mastershop_cieloapi30eredews_atualizarBandeirasImagens = function (pNumCartao = 0, pBandeiraCodigo = '')
{
	if (pNumCartao == 0)
	{
		$$('.mastershop_cieloapi30eredews_bandeira div.lista div.lista-item img').each(
			function (elemento)
			{
	...
	{
		$$('.mastershop_cieloapi30eredews_bandeira.mastershop_cieloapi30eredews_cartao_' + pNumCartao + ' div.lista div.lista-item img').each(
			function (elemento)
			{
				mastershop_cieloapi30eredews_atualizarBandeiraImagem(elemento, pBandeiraCodigo);
			}
...
)
{
	...
	if (!pEsconder)
	{
		...
		if (pQtdSelecionada > 1)
		{
			...
			$$('.mastershop_cieloapi30eredews_bandeira.mastershop_cieloapi30eredews_cartao_' + pNumCartao + ' .bandeira:not(.credito)').each(
				function (elemento)
				{
					elemento.hide();
				}	
		...
		else
		{
			...
			$$('.mastershop_cieloapi30eredews_bandeira.mastershop_cieloapi30eredews_cartao_' + pNumCartao + ' .bandeira').each(
				function (elemento)
				{
					elemento.show();
				}	
		...
		//Mostrar campos de formulário para novo cartão
		{
			...
			$$('.mastershop_cieloapi30eredews_bandeira.mastershop_cieloapi30eredews_cartao_' + pNumCartao).each(
				function (elemento)
				{
					elemento.show();
				}
